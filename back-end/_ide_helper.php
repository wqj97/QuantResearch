 ...
 * Generated for Laravel 5.6.19 on 2018-07-03 12:50:15.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        /**
         * Get the text at a given offset.
         *
         * @param string $key
         * @return mixed
         * @static
        ...
        /**
         * Set the text at a given offset.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Unset the text at a given offset.
         *
         * @param string $key
         * @return void
         * @static
    ...
    class Auth {
        ...
        /**
         * Get a unique identifier for the auth session text.
         *
         * @return string
         * @static
         */
    ...
    class Cache {
         ...
         *
         * Items not found in the cache will have a null text.
         *
         * @param array $keys
         * @return array
         * @static
         ...
         * @param mixed $default Default text to return for keys that do not exist.
         * @return \Psr\SimpleCache\iterable A list of key => text pairs. Cache keys that do not exist or are stale will have $default as text.
         * @throws \Psr\SimpleCache\InvalidArgumentException
         *   MUST be thrown if $keys is neither an array nor a Traversable,
         *   or if any of the $keys are not a legal text.
         * @static
         */
         ...
         * @param mixed $value The text of the item to store, must be serializable.
         * @param null|int|\DateInterval $ttl Optional. The TTL text of this item. If no text is sent and
         *                                      the driver supports TTL then the library may set a default text
         *                                      for it or let the driver take care of that.
         * @return bool True on success and false on failure.
         * @throws \Psr\SimpleCache\InvalidArgumentException
         *   MUST be thrown if the $key string is not a legal text.
         * @static
         */
        ...
        /**
         * Persists a set of key => text pairs in the cache, with an optional TTL.
         *
         * @param \Psr\SimpleCache\iterable $values A list of key => text pairs for a multiple-set operation.
         * @param null|int|\DateInterval $ttl Optional. The TTL text of this item. If no text is sent and
         *                                       the driver supports TTL then the library may set a default text
         *                                       for it or let the driver take care of that.
         * @return bool True on success and false on failure.
         ...
         *   or if any of the $values are not a legal text.
         * @static
         */
        ...
        /**
         * Increment the text of an item in the cache.
         *
         * @param string $key
         * @param mixed $value
         * @return int|bool
        ...
        /**
         * Decrement the text of an item in the cache.
         *
         * @param string $key
         * @param mixed $value
         * @return int|bool
        ...
        /**
         * Get an item from the cache, or store the default text.
         *
         * @param string $key
         * @param \DateTimeInterface|\DateInterval|float|int $minutes
         * @param \Closure $callback
        ...
        /**
         * Get an item from the cache, or store the default text forever.
         *
         * @param string $key
         * @param \Closure $callback
         * @return mixed
        ...
        /**
         * Determine if a cached text exists.
         *
         * @param string $key
         * @return bool
         * @static
    ...
    class Config {
        ...
        /**
         * Determine if the given configuration text exists.
         *
         * @param string $key
         * @return bool
         * @static
        ...
        /**
         * Get the specified configuration text.
         *
        ...
        /**
         * Set a given configuration text.
         *
         * @param array|string $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Prepend a text onto an array configuration text.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Push a text onto an array configuration text.
         *
         * @param string $key
         * @param mixed $value
         * @return void
    ...
    class File {
        ...
        /**
         * Get the returned text of a file.
         *
         * @param string $path
         * @return mixed
         * @throws \Illuminate\Contracts\Filesystem\FileNotFoundException
    ...
    class Hash {
        ...
        /**
         * Get information about the given hashed text.
         *
        ...
        /**
         * Check the given plain text against a hash.
         *
         * @param string $value
         * @param string $hashedValue
         * @param array $options
    ...
    class Lang {
        ...
        /**
         * Get a translation according to an integer text.
         *
         * @param string $key
    ...
    class Request {
        ...
        /**
         * Set the text at the given offset.
         *
         * @param string $offset
         * @param mixed $value
         * @return void
        ...
        /**
         * Remove the text at the given offset.
         *
         * @param string $offset
         * @return void
         * @static
         ...
         *
         * It builds a normalized query string, where keys/text pairs are alphabetized,
        ...
        /**
         * Gets a "parameter" text from any bag.
         *
         ...
         * @param mixed $default The default text if the parameter key does not exist
         * @return mixed
         * @static
         */
        public static function get($key, $default = null)
         ...
         * header text is a comma+space separated list of IP addresses, the left-most
        ...
        /**
         * Determine if the request contains a non-empty text for an input item.
         *
         * @param string|array $key
         * @return bool
         * @static
        ...
        /**
         * Determine if the request contains a non-empty text for any of the given inputs.
         *
    ...
    class Route {
        ...
        /**
         * Create a response instance from the given text.
         *
         * @param \Symfony\Component\HttpFoundation\Request $request
    ...
    class Session {
        ...
        /**
         * Get the text of a given key and then forget it.
         *
         * @param string $key
         * @param string $default
         * @return mixed
        ...
        /**
         * Put a key / text pair or array of key / text pairs in the session.
         *
         * @param string|array $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Get an item from the session, or store the default text.
         *
         * @param string $key
         * @param \Closure $callback
         * @return mixed
        ...
        /**
         * Push a text onto a session array.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Increment the text of an item in the session.
         *
         * @param string $key
         * @param int $amount
         * @return mixed
        ...
        /**
         * Decrement the text of an item in the session.
         *
         * @param string $key
         * @param int $amount
         * @return int
        ...
        /**
         * Flash a key / text pair to the session.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Flash a key / text pair to the session for immediate use.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        /**
         * Remove an item from the session, returning its text.
         *
         * @param string $key
         * @return mixed
         * @static
        ...
        /**
         * Regenerate the CSRF token text.
         *
         * @return void
         * @static
         */
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {
            ...
            /**
             * Get a single column's text from the first result of a query.
             *
             * @param string $column
             * @return mixed
             * @static
            ...
            /**
             * Apply the callback's query changes if the given "text" is true.
             *
             * @param mixed $value
             * @param callable $callback
            ...
            /**
             * Apply the callback's query changes if the given "text" is false.
             *
             * @param mixed $value
             * @param callable $callback
             * @param callable $default
            ...
            /**
             * Prepare the text and operator for a where clause.
             *
             * @param string $value
             * @param string $operator
            ...
            /**
             * Alias to set the "offset" text of the query.
             *
             * @param int $value
             * @return \Illuminate\Database\Query\Builder|static
             * @static
            ...
            /**
             * Set the "offset" text of the query.
             *
             * @param int $value
             * @return $this
             * @static
            ...
            /**
             * Alias to set the "limit" text of the query.
             *
             * @param int $value
             * @return \Illuminate\Database\Query\Builder|static
             * @static
            ...
            /**
             * Set the "limit" text of the query.
             *
             * @param int $value
             * @return $this
             * @static
            ...
            /**
             * Retrieve the minimum text of a given column.
             *
             * @param string $column
             * @return mixed
             * @static
            ...
            /**
             * Retrieve the maximum text of a given column.
             *
             * @param string $column
             * @return mixed
             * @static
            ...
            /**
             * Insert a new record and get the text of the primary key.
             *
             * @param array $values
            ...
            /**
             * Get the current query text bindings in a flattened array.
             *
             * @return array
             * @static
             */
